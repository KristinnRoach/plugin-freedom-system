...
```bash
VST3_INSTALLED="/Library/Audio/Plug-Ins/VST3/${PRODUCT_NAME}.vst3"
AU_INSTALLED="/Library/Audio/Plug-Ins/Components/${PRODUCT_NAME}.component"
```
...
chmod -R 755 "/Library/Audio/Plug-Ins/Components/${PRODUCT_NAME}.component"
```
...
```bash
ls -ld "/Library/Audio/Plug-Ins/VST3/${PRODUCT_NAME}.vst3"
# Expected: drwxr-xr-x
```
...
```bash
ls -lh "/Library/Audio/Plug-Ins/VST3/${PRODUCT_NAME}.vst3"
ls -lh "/Library/Audio/Plug-Ins/Components/${PRODUCT_NAME}.component"
```
